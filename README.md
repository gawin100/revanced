...
**You can find prebuilt versions of revanced in [github actions](https://github.com/kawinpattanai/revanced/actions) (they are all built using this script. also non-root variant there includes vanced-microg.apk in it)**
## deps
...
* or
```sh
$ git clone https://github.com/kawinpattanai/revanced
$ cd revanced
$ ./patch.sh
```
### options
